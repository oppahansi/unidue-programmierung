...
public class Workshop {
  ...
  // Zusätzliches Array, um die Reparaturkosten zu speicher, die in nextDay()-Methode entstehen.
  public int[] repCosts;
  ...
  public Workshop(int capacity, int speed) {
    ...
    this.money = 1000;
    this.repCosts = new int[capacity];
  }
  ...
  public static void main(String[] args) {
    ...
    System.out.println("4. Stelle im ws.repCosts[3]: " + ws.repCosts[3]);
    System.out.println("5. Stelle im ws.repCosts[4]: " + ws.repCosts[4]);
    System.out.println();
    ...
    System.out.println("4. Stelle im ws2.repCosts[3]: " + ws2.repCosts[3]);
    System.out.println();
  ...
  public void nextDay() {
    ...
    for (int i = 0; i < cars.length; i++) {
      if (cars[i] != null) {
        if (cars[i].isDamaged() == true && counter < repairedCarsPerDay) {
          repCosts[i] = cars[i].getRepairCost();
          cars[i].repair();
          counter++;
        }
      }
