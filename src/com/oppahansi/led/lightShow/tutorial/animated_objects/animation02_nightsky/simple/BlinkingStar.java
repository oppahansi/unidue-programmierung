...
public class BlinkingStar {
	...
	private static final int BLINK_CHANCE = 100;
	private final Random rng;
	
	// play around with these constants to alter the appearance of the animation
	private static final int INNER_SPEED_SLOW	= 3;
	private static final int INNER_BASE_SLOW	= 50;
	private static final int INNER_SPEED_FAST	= 6;
	private static final int INNER_BASE_FAST	= 50;
	
	private static final int OUTER_SPEED_FAST	= 20;
	private static final int OUTER_BASE_FAST	= 15;
