...
public class Miniprojekt4 {
  ...
  public static void main(String args[]) {
    ...
    santamaria.neuerPatient(new Patient("Kurt", "Andrew", "01.10.1947", 20));
    ...
    santamaria.neuerPatient(new Patient("Rosa", "Samanta", "01.10.1984", 12));
    ...
    System.out.println("Kosten " + santamaria.berechnekosten(2) + " Euro");
  }
}
